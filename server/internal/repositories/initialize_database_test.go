...
var sysConfigs = []models.SysConfig{
	...
	},
	{
		...
		Value:       jsonMarshal(models.LoginMethod{Password: true, QQ: true, Github: true, Osc: true}),
		Name:        "Login Methods",
	...
	},
	{
		...
		Value:       jsonMarshal(models.ModulesConfig{Tweet: true, Topic: true, Article: true}),
