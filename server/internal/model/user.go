...
type User struct {
	...
	FollowersCount  int            `gorm:"type:int(11);not null" json:"followersCount" form:"followersCount"`    // Followers count
	FollowingCount  int            `gorm:"type:int(11);not null" json:"followingCount" form:"followingCount"`    // Following count
	RoleID          int64          `gorm:"index:idx_user_role_id" json:"roleId" form:"roleId"`                   // Role ID
