...
func BuildComment(comment *models.Comment) *CommentResponse {
	return doBuildComment(comment, nil, true, true)
}

func BuildComments(comments []models.Comment, currentUser *models.User, isBuildReplies, isBuildQuote bool) []CommentResponse {
	if len(comments) == 0 {
		return nil
	}
...
func doBuildComment(comment *models.Comment, currentUser *models.User, isBuildReplies bool, isBuildQuote bool) *CommentResponse {
	if comment == nil {
		return nil
	}
