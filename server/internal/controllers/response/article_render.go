...
func BuildArticle(article *models.Article, currentUser *models.User) *ArticleResponse {
	if article == nil {
		return nil
	}
...
func BuildSimpleArticle(article *models.Article) *ArticleSimpleResponse {
	if article == nil {
		return nil
	}
...
func BuildSimpleArticles(articles []models.Article) []ArticleSimpleResponse {
	if len(articles) == 0 {
		return nil
	}
