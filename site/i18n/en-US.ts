export default {
  ...
  message: {
    ...
    tag_description: 'You are browsing all the topics tagged with this tag. Explore and join the discussion!',
  },
  form: {
    button: {
      signin: 'Sign In',
    ...
    placeholder: {
      ...
      enter_location: 'Enter your city or country',
    ...
    help: {
      location_optional: 'Your city or country (optional)',
      nickname_public: 'Nickname will be displayed publicly on the forum',
      username_immutable: 'Username cannot be changed after registration',
      cannot_change: 'Cannot change',
      email_used_for_notifications: 'Email is used to receive notifications',
      change_in_account: 'Change in account',
      bio_limit: 'Short description about you (max 500 characters)',
    },
    settings: {
      public_profile_title: 'Public profile',
      public_profile_desc: 'Allow everyone to view your profile',
      show_location_title: 'Show location',
