export default {
  ...
  message: {
    ...
    mute_user_success: 'Đã tắt tiếng người dùng',
    mute_user_failure: 'Tắt tiếng người dùng thất bại',
  ...
  dialog: {
    ...
    message: {
      mute_user: 'Bạn có muốn tắt tiếng người dùng này?',
      mute_user_permanent: 'Bạn có muốn tắt tiếng người dùng này vĩnh viễn?',
  ...
  profile: {
    ...
    actions: {
      ...
      unmute: 'Bật tiếng',
      mute_7days: 'Tắt tiếng 7 ngày',
      mute_permanent: 'Tắt tiếng vĩnh viễn',
      follow: 'Theo dõi',
