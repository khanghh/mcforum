export default {
  ...
  message: {
    ...
    no_notifications_desc: 'Hiện chưa có thông báo nào. Khi có hoạt động mới, bạn sẽ thấy chúng tại đây.',
    comment: 'bình luận',
    commented_on_topic: 'đã bình luận về {topic} của bạn',
    replied_your_comment: 'đã trả lời {comment} của bạn',
    liked_your_topic: 'đã thích {topic} của bạn',
    favorited_your_topic: 'đã yêu thích {topic} của bạn',
    recommended_your_topic: 'đã đề xuất {topic} của bạn',
    ...
    your_updates: 'Hiển thị các cập nhật liên quan đến bạn',
    ...
    topic_waiting_for_deletion: 'Bài viết này bị xóa và không còn hiển thị công khai',
