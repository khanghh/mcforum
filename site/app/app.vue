<template>
  <NuxtLoadingIndicator color="#27ae60" :height="5" />
  <NuxtLayout>
    <NuxtPage />
  </NuxtLayout>
</template>
...
useSeoMeta({
  ...
  twitterImage: "https://mineviet.com/images/mineviet.png",
})
